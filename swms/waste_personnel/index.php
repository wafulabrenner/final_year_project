...
// If the user is logged in, continue displaying the dashboard or other content
...
<body>
    ...
    <ul class="dropdown-menu animated fadeInRight m-t-xs">
        ...
        <li><a href="./logout.php">Logout</a></li>
                    ...
                    <li>
                        <a href="../modules/user_management/user.php"><i class="fa fa-user-md"></i> <span class="nav-label">User Management</span></a>
                        
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-calendar"></i> <span class="nav-label">Collection Schedule</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="../modules/collection_schedule/personnel_collection_schedule.php">View Pickup Schedule</a></li>
                            <li><a href="../modules/collection_schedule/personnel_collection_schedule_edit.php">Schedule Pickup</a></li>
                        </ul>
                    </li>   
                    <li>
                        <a href="../modules/missed_pickups/missed_pickups.php"><i class="fa fa-trash"></i> <span class="nav-label">Missed Pickups</span></a>
                        
                    </li>  
                    <li>
                        <a href="../modules/reports/reports.php"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Reports</span></a>
                 
                    </li>  
                    <li>
                        <a href="../modules/feedback&issues/issues.php"><i class="fa fa-files-o"></i> <span class="nav-label">Feedback & Issues</span></a>
    ...
    <ul class="dropdown-menu dropdown-alerts" id="pickupList">
        ...
        <li>
            <div class="text-center link-block">
                <a href="../modules/collection_schedule/personnel_collection_schedule.php">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <h1 id="residents-count">Loading...</h1>
...
<div class="col-lg-3">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <h5>Missed Pickups</h5>
        </div>
        <div class="ibox-content">
            <h1 id="pickup-alerts-count">Loading...</h1>
...
<div class="col-lg-3">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <h1 id="pickup-alerts-count-last-month">Loading...</h1>
...
<div class="col-lg-3">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <h1 id="feedback-count">Loading...</h1>
    ...
    <div class="col-lg-6">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <canvas id="missedPickupsChart" width="400" height="200"></canvas>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-primary pull-right">Upcoming Schedules</span>
            ...
            <div class="ibox-content">
                <table class="table">
                    ...
                    <tbody id="upcoming-schedules-table">
                        <!-- This is where the upcoming schedules will be dynamically inserted -->
                    </tbody>
                </table>
            </div>
        </div>
...
function fetchAndUpdateProfilePic() {
    $.ajax({
        url: 'fetch_personnel_details.php', // endpoint for fetching user details
        method: 'GET',
        dataType: 'json',
...
document.getElementById('profile-link').addEventListener('click', function(e) {
    ...
    document.getElementById('profile-pic-input').addEventListener('change', function() {
        ...
        fetch('fetch_personnel_pic_details.php', {
                method: 'POST',
                body: formData
            })
    ...
    $.ajax({
        ...
        $.ajax({
            url: 'fetch_upcoming_schedules.php',
            type: 'GET',
            success: function(response) {
                var schedules = JSON.parse(response);

                if (schedules.length === 0) {
                    $('#upcoming-schedules-table').html('<tr><td colspan="6">No pickups scheduled</td></tr>');
                    return;
                }
                ...
                schedules.forEach(function(schedule) {
                    scheduleHtml += '<tr>';
                    scheduleHtml += '<td>' + schedule.date + '</td>';
                    scheduleHtml += '<td>' + schedule.time + '</td>';
                    scheduleHtml += '<td>' + schedule.address + '</td>';
                  
                    scheduleHtml += '</tr>';
                });

                $('#upcoming-schedules-table').html(scheduleHtml);
            },
            error: function(xhr, status, error) {
    ...
    // Initial call to fetch data and display
    ...
    setInterval(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var ctx = document.getElementById('missedPickupsChart').getContext('2d');

                var missedPickupsChart = new Chart(ctx, {
                    type: 'bar',
                    data: chartData,
                    options: {
                        scales: {
    ...
    // Initial call to fetch data and create chart
    fetchChartData();
    ...
    setInterval(function() {
        ...
        setTimeout(function() {
            ...
            toastr.success('Welcome Personnel');
        }, 1000);

        function updateChart() {
            // Fetch residents count
            $.ajax({
                url: 'fetch_residents_count.php',
                type: 'GET',
                success: function(response) {
                    $('#residents-count').text(response);
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
            ...
            // Fetch pickup alerts count
            $.ajax({
                url: 'fetch_pickup_alerts_count.php',
                type: 'GET',
                success: function(response) {
                    $('#pickup-alerts-count').text(response);
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
            ...
            $.ajax({
                url: 'pickup-alerts-count-last-month.php',
                type: 'GET',
                success: function(response) {
                    $('#pickup-alerts-count-last-month').text(response);
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
            ...
            $.ajax({
                url: 'fetch_feedback_count.php',
                type: 'GET',
                success: function(response) {
                    $('#feedback-count').text(response);
                },
                error: function(xhr, status, error) {
                    console.error(xhr.responseText);
                }
