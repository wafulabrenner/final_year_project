    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        ...
        <p>Login in to continue.</p>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "SELECT * FROM waste_personnel WHERE work_id='$workId'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    if (password_verify($password, $row['password'])) {
                        ...
                        echo '<div class="alert alert-danger">Invalid Work ID or password</div>';
                    }
                } else {
                    echo '<div class="alert alert-danger">Invalid Work ID or password</div>';
                }
            ...
            <form class="m-t" role="form" action="#" method="POST">
                    <div class="form-group">
                        <input type="text" id="workId" name="work_id" placeholder="Enter Work-ID" class="form-control" required="">
                    </div>
                <div class="form-group">
