...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        header("Location: missed_pickups_residents.php?status=success");
        exit();
    } else {
        // Insert failed, show error message
        header("Location: missed_pickups_residents.php?status=fail");
        exit();
    }
}
...
<body>
    ...
    <ul class="dropdown-menu animated fadeInRight m-t-xs">
        ...
        <li><a href="../../residents/logout.php">Logout</a></li>
                    ...
                    <li>
                        <a href="../feedback&issues/resident_issues.php"><i class="fa fa-files-o"></i> <span class="nav-label">Feedback & Issues</span></a>
    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>Report Missed Pickup</h5>
            </div>
            <div class="ibox-content" id="reportFormContainer" style="display: none;">
                <form id="missedPickupForm" class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="text-center p-lg">
                    ...
                    <button id="reportButton" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <span class="bold">Report</span></button>
                </div>
            </div>
        </div>
    </div>
